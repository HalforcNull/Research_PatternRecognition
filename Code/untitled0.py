...
readTrainingData( 'C:/DataProcessWorkSpace/AllC16Data.csv', '16 Cell')
readTrainingData( 'C:/DataProcessWorkSpace/AllC8Data.csv', '8 Cell')
readTrainingData( 'C:/DataProcessWorkSpace/AllC4Data.csv', '4 Cell')
model = GaussianNB() 
